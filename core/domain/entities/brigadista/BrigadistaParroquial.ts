...
export class BrigadistaParroquial {
  ...
  toggleDisponibilidad(): void {
    ...
    this.setDisponibilidad(quiereDisponible ? DISPONIBILIDAD.DISPONIBLE : DISPONIBILIDAD.NO_DISPONIBLE)
  }
  ...
  private setDisponibilidad(valor: string): void {
    if (valor !== DISPONIBILIDAD.NO_DISPONIBLE && this.props.estado !== ESTADO.ACTIVO) {
      throw new BusinessRuleError('Un brigadista inactivo no puede marcarse como disponible o en campo.')
    }
    this.props.disponibilidad = valor
  }

  get id(): string { return this.props.id }
  get dni(): string | null | undefined { return this.props.dni }
