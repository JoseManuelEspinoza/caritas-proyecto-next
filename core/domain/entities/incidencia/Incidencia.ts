...
export class Incidencia {
  ...
  asignar(): void { this.transicion('ASIGNADO') }
  registrarCampo(): void { this.transicion('DATA RECOPILADA') }
  enviarEvaluacion(): void { this.transicion('EN EVALUACION') }
  aprobar(): void { this.transicion('APROBADO') }
  observar(): void { this.transicion('OBSERVADO') }
  rechazar(): void { this.transicion('RECHAZADO') }
  atender(): void { this.transicion('ATENDIDO') }
  iniciarSeguimiento(): void { this.transicion('SEGUIMIENTO ABIERTO') }
  cerrar(): void { this.transicion('CERRADO') }
  ...
  get estadoActual(): EstadoIncidencia { return this.props.estadoActual }
  get estadoAnterior(): EstadoIncidencia | undefined { return this._estadoAnterior }
  get idAviso(): string | null | undefined { return this.props.idAviso }
  get snapshot(): Readonly<IncidenciaProps> { return this.props }
}
