...
export default async function BrigadistasPage() {
  ...
  const stats = {
    ...
    disponibles: brigadistas.filter((b) => b.disponibilidad === 'DISPONIBLE' && b.estado === 'ACTIVO').length,
  ...
  return (
    <BrigadistasList
      brigadistas={brigadistas.map((b) => ({
        ...
        parroquia:     b.parroquia
          ? { id: b.parroquia.idParroquia, nombre: b.parroquia.nombre }
          : null,
      }))}
