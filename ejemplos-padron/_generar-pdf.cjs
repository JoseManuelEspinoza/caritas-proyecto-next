...
const filas = [
  ['GF 1',    'DNI', '60587924',  'Juan Carlos', 'Valverde',  'Torres', '32', 'Masculino', '987654321', 'Jefe',    'Herido'],
  ['GF 1',    'DNI', '45221033',  'Maria Elena', 'Valverde',  'Rios',   '28', 'Femenino',  '987111222', 'Conyuge', 'Gestante'],
  ['GF 1',    'DNI', '71234567',  'Pedro',       'Valverde',  'Rios',   '8',  'Masculino', '',          'Hijo',    ''],
  ['',        'DNI', '60582332',  'Rosa',        'Carhuapoma','Diaz',   '21', 'Femenino',  '999888777', '',        'Con Lactancia'],
  ['Mendoza', 'CE',  '001234567', 'Carmen',      'Mendoza',   'Soto',   '67', 'Femenino',  '',          'Madre',   'Adulto mayor'],
]
...
doc.setDrawColor(150); doc.line(6, y + 1.5, 193, y + 1.5)
y += 6

doc.setFont('helvetica', 'normal')
for (const fila of filas) {
  cols.forEach((c, i) => { if (fila[i]) doc.text(String(fila[i]), c.x, y) })
  y += 6
}
